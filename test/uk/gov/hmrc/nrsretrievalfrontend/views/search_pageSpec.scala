...
import uk.gov.hmrc.nrsretrievalfrontend.controllers.SearchController
import uk.gov.hmrc.nrsretrievalfrontend.model.SearchQuery
import uk.gov.hmrc.nrsretrievalfrontend.support.GuiceAppSpec
import uk.gov.hmrc.nrsretrievalfrontend.support.fixtures.ViewFixture
