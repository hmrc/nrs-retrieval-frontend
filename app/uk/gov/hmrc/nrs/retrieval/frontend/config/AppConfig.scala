...
package uk.gov.hmrc.nrs.retrieval.frontend.config
...
import uk.gov.hmrc.nrs.retrieval.frontend.model.{Service, ServiceScope, SubmissionType}
import uk.gov.hmrc.nrs.retrieval.frontend.model.{Service, SubmissionType}
